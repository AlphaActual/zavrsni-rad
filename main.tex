...
\usepackage{float}
\usepackage{pdfpages}  %za uključivanje PDF stranica
...
% Uključivanje PDF stranica
\includepdf[pages=-]{Izjava_o_akademskoj_cestitosti.pdf}
\includepdf[pages=-]{Izjava_o_koristenju_autorskog_djela.pdf}
...
\input{3-rezultati/about}
\newpage

\input{3-rezultati/blog}
\newpage

\input{3-rezultati/blog-post}
\newpage

\input{3-rezultati/final}
\newpage

\input{3-rezultati/additional-metrics}
\newpage
