    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|l|l|l|}
            ...
            \multirow{3}{*}{\textbf{Programski okviri}}
                                & 1. Next.js                                   & 95.1\%             \\[0.2em]
                                & 2. Nuxt.js                                   & 88.5\%             \\[0.2em]
                                & 3. SvelteKit                                 & 87.4\%             \\
            \hline
            \multirow{4}{*}{\textbf{Strategije iscrtavanja}}
                                & 1. Server-Side Rendering                     & 91.3\%             \\[0.2em]
                                & 2. Incremental Static Regeneration           & 90.6\%             \\[0.2em]
                                & 3. Static Site Generation                    & 90.6\%             \\[0.2em]
                                & 4. Client-Side Rendering                     & 88.8\%             \\
            \hline
            \multirow{5}{*}{\textbf{Najbolje kombinacije}}
                                & 1. Next.js + Incremental Static Regeneration & 96.8\%             \\[0.2em]
                                & 2. Next.js + Static Site Generation          & 96.8\%             \\[0.2em]
                                & 3. Nuxt.js + Server-Side Rendering           & 94.3\%             \\[0.2em]
                                & 4. Next.js + Server-Side Rendering           & 94.2\%             \\[0.2em]
                                & 5. Next.js + Client-Side Rendering           & 92.5\%             \\
            \hline
